/**
 * Hardcover Cookbook Generator (8.25" x 11")
 * Generates an HTML file optimized for 8.25" x 11" hardcover printing
 * WITH page numbers in footer, TOC, and index
 * Centered recipe layout
 *
 * Usage: node generate-hardcover-8.25x11.js
 * Output: output/hardcover-8.25x11.html
 * Then: weasyprint hardcover-8.25x11.html hardcover-8.25x11.pdf
 */
...
const outputPath = path.join(outputDir, 'hardcover-8.25x11.html');
fs.writeFileSync(outputPath, htmlContent, 'utf8');

console.log(`
==========================================
  Hardcover Cookbook Generated (8.25x11)
==========================================
...
To generate PDF:
  cd output
  weasyprint hardcover-8.25x11.html hardcover-8.25x11.pdf

Features:
- Page numbers in footer (inside content area)
- Page numbers in Table of Contents
- Page numbers in Index
- Centered recipe layout
- KDP-compliant margins for 8.25"x11" hardcover
